...
export default function TrigKuadranCalculator() {
  ...
  const hitungNilaiTrigonometri = () => {
    ...
    // Tentukan K berdasarkan titik terdekat
    let k = 0;
    ...
    // Konversi ke radian untuk perhitungan
    ...
    // Dapatkan nilai eksak dari sudut referensi
    const nilaiEksak = getNilaiEksak(sudutRef);

    // Tanda untuk setiap fungsi
  ...
  const contohSoal = (sudutVal) => {
    ...
    setTimeout(() => hitungNilaiTrigonometri(), 100);
  };
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-6 md:p-8">
          ...
          <div className="bg-yellow-50 rounded-xl p-4 mb-6">
            ...
            <div className="flex flex-wrap gap-2">
              <button onClick={() => contohSoal(30)} className="px-4 py-2 bg-white border-2 border-yellow-300 rounded-lg hover:bg-yellow-100 text-sm font-medium">
                30° (dekat 0°)
              </button>
              <button onClick={() => contohSoal(60)} className="px-4 py-2 bg-white border-2 border-yellow-300 rounded-lg hover:bg-yellow-100 text-sm font-medium">
                60° (dekat 90°)
              </button>
              <button onClick={() => contohSoal(135)} className="px-4 py-2 bg-white border-2 border-yellow-300 rounded-lg hover:bg-yellow-100 text-sm font-medium">
                135° (dekat 180°)
              </button>
              <button onClick={() => contohSoal(210)} className="px-4 py-2 bg-white border-2 border-yellow-300 rounded-lg hover:bg-yellow-100 text-sm font-medium">
                210° (dekat 180°)
              </button>
              <button onClick={() => contohSoal(240)} className="px-4 py-2 bg-white border-2 border-yellow-300 rounded-lg hover:bg-yellow-100 text-sm font-medium">
                240° (dekat 270°)
              </button>
              <button onClick={() => contohSoal(315)} className="px-4 py-2 bg-white border-2 border-yellow-300 rounded-lg hover:bg-yellow-100 text-sm font-medium">
                315° (dekat 270°)
              </button>
              <button onClick={() => contohSoal(350)} className="px-4 py-2 bg-white border-2 border-yellow-300 rounded-lg hover:bg-yellow-100 text-sm font-medium">
                350° (dekat 360°)
              </button>
            </div>
          </div>
